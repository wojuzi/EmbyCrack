...
+ 将 [破解程序集](https://github.com/wojuzi/EmbyCrack/tree/master/assembly) https://github.com/YukiCoco/EmbyCrack/tree/master/assembly
替换原有文件即完成破解，原有文件路径为 `system/System.Net.Http.dll`
+ 客户端使用:
